...
#define ELOSS_TAGR_LH2          1 // LH2 (dencity 0.0708 g/cc)
#define ELOSS_TAGR_SCINT        2 // plastic scintillator
#define ELOSS_TAGR_C12_17       3 // carbon (density 1.7 g/cc)
#define ELOSS_TAGR_LD2          4 // LD2 (dencity 0.1623 g/cc)
#define ELOSS_TAGR_LH3          5 // L3He (dencity 0.072 g/cc)
#define ELOSS_TAGR_AL           6 // Al
#define ELOSS_TAGR_LHE4         7 // L4He (dencity 0.14 g/cc)
#define ELOSS_TAGR_AIR          8 // air (gas, dencity 0.0129*10^-3 g/cc)
#define ELOSS_TAGR_BUT_G9A      9 // butanol g9a (density 0.538 g/cc)      
#define ELOSS_TAGR_CH2         10 // polyethylene (CH2) g9a (density 1.41 g/cc) 
#define ELOSS_TAGR_C12_G9A     11 // carbon g9a (density 1.926 g/cc)
#define ELOSS_TAGR_SCON        12 // superconduction wire
#define ELOSS_TAGR_PTFE        13 // PCTFE
